...
#ifndef __SIFT3D_IMTYPES_PRIVATE_H__
#define __SIFT3D_IMTYPES_PRIVATE_H__
...
typedef struct _sift3d_mat_rm {
    ...
    sift3d_mat_type type;       // DOUBLE, FLOAT, or INT
} sift3d_mat_rm;
...
typedef struct _sift3d_keypoint_store {
    sift3d_keypoint *buf;
    sift3d_slab slab;
